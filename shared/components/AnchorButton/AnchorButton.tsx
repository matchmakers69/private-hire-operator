...
const anchorButton = cva(
  "inline-flex items-center min-w-[12rem] justify-center leading-none font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      intent: {
        primary:
